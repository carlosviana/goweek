...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, KeyboardAvoidingView, AsyncStorage, } from 'react-native';
        ...
        <KeyboardAvoidingView style={styles.container} behavior="height"> 
            <View style={styles.content}>
                ...
                <TextInput 
                    ...
                    onChangeText={this.handleInoutChange}
                    returnKeyType="send"
